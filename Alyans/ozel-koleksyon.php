...
<div id="site-wrapper">
  ...
  <div id="header">
    ...
    <div class="container">
      ...
      <div id="top">
       ...
       <div id="main-nav">
          <ul class="sf-menu" style="margin-right:20px;">
            ...
            <li class="current_page_item"><a href="ozel-koleksyon.php">Özel Koleksiyon</a></li>
      ...
      <!-- top END here -->
      <div id="pagename">
        <h2><span>Özel Koleksiyon</span></h2><img src="images/1.png" style="margin-top:25px; margin-left:-30px;"/>
      </div>
    </div>
  </div>
  <div id="content">
...
<?php
		 ...
		 { 
		   if($dosya != "." && $dosya !="..")
		   {
		    echo "<li><a><img src='img/ozel-koleksiyon/{$dosya}' alt='' class='resim' /><img src='img/ozel-koleksiyon/{$dosya}' alt='' class='preview' /></a></li>";
		   }
		 }
		 closedir($ac);
	   ?>
