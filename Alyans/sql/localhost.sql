...
--
-- Anamakine: localhost
-- Üretim Zamanı: 16 Nisan 2013 saat 02:16:13
...
-- Veritabanı: `alyans`
--
CREATE DATABASE `alyans` DEFAULT CHARACTER SET utf8 COLLATE utf8_turkish_ci;
USE `alyans`;
...
(14, 'Deneme', 'deneme_deneme@hotmail.com', 'Merhaba ben deneme yazısıyım', '0'),
(15, 'Post title goes here', 'deneme_deneme@hotmail.com', 'John Doe on April 10, 2010', '0'),
(16, 'Post title goes here', 'deneme_deneme@hotmail.com', 'John Doe on April 10, 2010', '0'),
(17, 'Post title goes here', 'deneme_deneme@hotmail.com', 'John Doe on April 10, 2010', '0'),
(18, 'Post title goes here', 'deneme_deneme@hotmail.com', 'John Doe on April 10, 2010', '0'),
(19, 'Post title goes here', 'deneme_deneme@hotmail.com', 'John Doe on April 10, 2010', '0');
...
INSERT INTO `uyeler` (`id`, `kadi`, `sifre`, `eposta`) VALUES
(1, 'Kamil', '123456', 'kamil_kaplan@ymail.com');
--
...
--
-- Tablo döküm verisi `CHARACTER_SETS`
--
...
--
-- Tablo yapısı: `COLLATION_CHARACTER_SET_APPLICABILITY`
--
...
--
-- Tablo döküm verisi `COLLATION_CHARACTER_SET_APPLICABILITY`
--
...
(NULL, 'alyans', 'mesajlar', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'alyans', 'mesajlar', 'yazan', 2, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_turkish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'alyans', 'mesajlar', 'eposta', 3, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_turkish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'alyans', 'mesajlar', 'mesaj', 4, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_turkish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'alyans', 'mesajlar', 'onay', 5, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_turkish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'alyans', 'uyeler', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'alyans', 'uyeler', 'kadi', 2, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_turkish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'alyans', 'uyeler', 'sifre', 3, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_turkish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'alyans', 'uyeler', 'eposta', 4, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_turkish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
...
--
-- Tablo yapısı: `COLUMN_PRIVILEGES`
--
...
--
-- Tablo döküm verisi `COLUMN_PRIVILEGES`
--
...
--
-- Tablo döküm verisi `KEY_COLUMN_USAGE`
--
...
(NULL, 'alyans', 'PRIMARY', NULL, 'alyans', 'mesajlar', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'alyans', 'PRIMARY', NULL, 'alyans', 'uyeler', 'id', 1, NULL, NULL, NULL, NULL),
...
--
-- Tablo döküm verisi `SCHEMA_PRIVILEGES`
--
...
(NULL, 'alyans', 'mesajlar', 0, 'alyans', 'PRIMARY', 1, 'id', 'A', 6, NULL, NULL, '', 'BTREE', ''),
(NULL, 'alyans', 'uyeler', 0, 'alyans', 'PRIMARY', 1, 'id', 'A', 1, NULL, NULL, '', 'BTREE', ''),
...
(NULL, 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 0, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-04-16 02:16:14', '2013-04-16 02:16:14', NULL, 'utf8_general_ci', NULL, 'max_rows=3540', ''),
...
(NULL, 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 0, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-04-16 02:16:14', '2013-04-16 02:16:14', NULL, 'utf8_general_ci', NULL, 'max_rows=3726', ''),
...
(NULL, 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 0, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-04-16 02:16:14', '2013-04-16 02:16:14', NULL, 'utf8_general_ci', NULL, 'max_rows=3108', ''),
...
(NULL, 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 0, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-04-16 02:16:14', '2013-04-16 02:16:14', NULL, 'utf8_general_ci', NULL, 'max_rows=6123', ''),
(NULL, 'alyans', 'mesajlar', 'BASE TABLE', 'InnoDB', 10, 'Compact', 6, 2730, 16384, 0, 0, 0, 20, '2013-04-15 21:48:26', NULL, NULL, 'utf8_turkish_ci', NULL, '', 'InnoDB free: 4096 kB'),
(NULL, 'alyans', 'uyeler', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 0, 0, 2, '2013-04-15 21:48:26', NULL, NULL, 'utf8_turkish_ci', NULL, '', 'InnoDB free: 4096 kB'),
(NULL, 'mysql', 'columns_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 227994731135631359, 1024, 0, NULL, '2008-01-11 17:23:57', '2008-01-11 17:23:58', NULL, 'utf8_bin', NULL, '', 'Column privileges'),
(NULL, 'mysql', 'db', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 2, 438, 876, 123286039799267327, 4096, 0, NULL, '2008-01-11 17:23:56', '2008-01-11 17:23:58', '2008-01-11 17:23:58', 'utf8_bin', NULL, '', 'Database privileges'),
(NULL, 'mysql', 'func', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162974011515469823, 1024, 0, NULL, '2008-01-11 17:23:57', '2008-01-11 17:23:58', NULL, 'utf8_bin', NULL, '', 'User defined functions'),
(NULL, 'mysql', 'help_category', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 36, 581, 20916, 163536961468891135, 3072, 0, NULL, '2008-01-11 17:23:57', '2008-01-11 17:23:58', NULL, 'utf8_general_ci', NULL, '', 'help categories'),
(NULL, 'mysql', 'help_keyword', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 401, 197, 78997, 55450570411999231, 14336, 0, NULL, '2008-01-11 17:23:57', '2008-01-11 17:23:58', NULL, 'utf8_general_ci', NULL, '', 'help keywords'),
(NULL, 'mysql', 'help_relation', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 825, 9, 7425, 2533274790395903, 16384, 0, NULL, '2008-01-11 17:23:57', '2008-01-11 17:24:00', NULL, 'utf8_general_ci', NULL, '', 'keyword-topic relation'),
(NULL, 'mysql', 'help_topic', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 475, 730, 347064, 281474976710655, 17408, 0, NULL, '2008-01-11 17:23:57', '2008-01-11 17:23:58', NULL, 'utf8_general_ci', NULL, '', 'help topics'),
(NULL, 'mysql', 'host', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 109775240917155839, 1024, 0, NULL, '2008-01-11 17:23:56', '2008-01-11 17:23:56', NULL, 'utf8_bin', NULL, '', 'Host privileges;  Merged with database privileges'),
(NULL, 'mysql', 'proc', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2008-01-11 17:23:58', '2008-01-11 17:23:58', NULL, 'utf8_general_ci', NULL, '', 'Stored Procedures'),
(NULL, 'mysql', 'procs_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239253730204057599, 1024, 0, NULL, '2008-01-11 17:23:58', '2008-01-11 17:23:58', NULL, 'utf8_bin', NULL, '', 'Procedure privileges'),
(NULL, 'mysql', 'tables_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239535205180768255, 1024, 0, NULL, '2008-01-11 17:23:57', '2008-01-11 17:23:58', NULL, 'utf8_bin', NULL, '', 'Table privileges'),
(NULL, 'mysql', 'time_zone', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 1970324836974591, 1024, 0, 1, '2008-01-11 17:23:57', '2008-01-11 17:23:58', NULL, 'utf8_general_ci', NULL, '', 'Time zones'),
(NULL, 'mysql', 'time_zone_leap_second', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 3659174697238527, 1024, 0, NULL, '2008-01-11 17:23:58', '2008-01-11 17:23:58', NULL, 'utf8_general_ci', NULL, '', 'Leap seconds information for time zones'),
(NULL, 'mysql', 'time_zone_name', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 55450570411999231, 1024, 0, NULL, '2008-01-11 17:23:57', '2008-01-11 17:23:58', NULL, 'utf8_general_ci', NULL, '', 'Time zone names'),
(NULL, 'mysql', 'time_zone_transition', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 4785074604081151, 1024, 0, NULL, '2008-01-11 17:23:57', '2008-01-11 17:23:58', NULL, 'utf8_general_ci', NULL, '', 'Time zone transitions'),
(NULL, 'mysql', 'time_zone_transition_type', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 10696049115004927, 1024, 0, NULL, '2008-01-11 17:23:58', '2008-01-11 17:23:58', NULL, 'utf8_general_ci', NULL, '', 'Time zone transition types'),
(NULL, 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 5, 51, 256, 281474976710655, 2048, 0, NULL, '2008-01-11 17:23:56', '2008-01-11 17:23:58', NULL, 'utf8_bin', NULL, '', 'Users and global privileges');

-- --------------------------------------------------------

--
-- Tablo yapısı: `TABLE_CONSTRAINTS`
--
...
--
-- Tablo döküm verisi `TABLE_CONSTRAINTS`
--
...
(NULL, 'alyans', 'PRIMARY', 'alyans', 'mesajlar', 'PRIMARY KEY'),
(NULL, 'alyans', 'PRIMARY', 'alyans', 'uyeler', 'PRIMARY KEY'),
...
--
-- Tablo döküm verisi `TABLE_PRIVILEGES`
--
...
--
-- Tablo döküm verisi `USER_PRIVILEGES`
--
...
--
-- Tablo döküm verisi `columns_priv`
--
...
--
-- Tablo döküm verisi `help_category`
--
...
--
-- Tablo döküm verisi `help_keyword`
--
...
--
-- Tablo döküm verisi `help_relation`
--
...
--
-- Tablo döküm verisi `tables_priv`
--
...
--
-- Tablo yapısı: `time_zone_leap_second`
--
...
--
-- Tablo döküm verisi `time_zone_leap_second`
--
...
--
-- Tablo döküm verisi `time_zone_name`
--
...
--
-- Tablo yapısı: `time_zone_transition`
--
...
--
-- Tablo döküm verisi `time_zone_transition`
--
...
--
-- Tablo yapısı: `time_zone_transition_type`
--
...
--
-- Tablo döküm verisi `time_zone_transition_type`
--
